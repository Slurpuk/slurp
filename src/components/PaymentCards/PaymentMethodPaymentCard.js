  ...
  return (
    <View>
      {card !== null ? (
        ...
        >
          <PaymentIcon
            style={{marginEnd: '5%', left: '4%'}}
            type={formattedCardBrand}
          />
          <Text style={[textStyles.greyPoppins, {marginEnd: '2%'}]}>
            *** **** **** {card.last4}
          </Text>
          {card.isDefault ? (
            <Text style={[textStyles.lightGreyPoppins, {marginLeft: '8%'}]}>
              Default
            </Text>
          ) : (
            <Text style={[textStyles.lightGreyPoppins, {marginLeft: '7%'}]}>
              Secondary
            </Text>
          )}
        </View>
        ...
        >
          ...
          <Text style={[textStyles.lightGreyPoppins, {fontStyle: 'italic'}]}>
      ...
      {isFirst ? (
        <View
          style={[
            styles.line,
            {maxWidth: '100%', marginBottom: '3%', marginTop: '2%'},
          ]}
        />
      ) : (
